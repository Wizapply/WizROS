...
{    
    ...
    uint8_t cleanup = RCREG;	// rx cleanup
...
//Rx
void wzEUSARTHandleRxInt()
{
    //Read the data
    int8_t data;

    data = RCREG; //throw away
